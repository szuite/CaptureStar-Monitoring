...
class HumidityByPeriodForm extends StatefulWidget {
  final String? title;

  const HumidityByPeriodForm({@required this.title, Key? key})
      : super(key: key);

  @override
  _HumidityByPeriodFormState createState() => _HumidityByPeriodFormState();
}

class _HumidityByPeriodFormState extends State<HumidityByPeriodForm> {
  @override
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                height: 230,
                child: VerticalBarChart(colors: AppThemes.blue),
              ),
            ],
          ),
        ),
